...
databaseChangeLog(logicalFilePath: '.') {
  ...
  changeSet(id: 'rename-column', author: 'stevesaliman') {
    renameColumn(schemaName: 'animal', tableName: 'monkey_table',
		         oldColumnName: 'birthday', newColumnName: 'monkey_birthday', columnDataType: 'char')
  }
...
//  }
  ...
  changeSet(id: 'rename-view', author: 'stevesaliman') {
    renameView(schemaName: 'animal', oldViewName: 'monkey_emotion', newViewName: 'monkey_emotion_vw')
  }
  ...
  changeSet(id: 'add-lookup-table', author: 'stevesaliman') {
    addLookupTable(existingTableName: 'monkey_emotion', existingColumnName: 'emotion',
		    newTableName: 'monkey_emotion', newColumnName: 'emotion', constraintName: 'monkey_emotion_fk')
  }
  ...
  changeSet(id: 'add-foreign-key-constraint', author: 'stevesaliman') {
    addForeignKeyConstraint(constraintName: 'monkey_emotion_fk',
                            baseTableName: 'monkey_table', baseTableSchemaName: 'animal', baseColumnNames: 'emotion_id',
                            referencedTableName: 'emotion', referencedTableSchemaName: 'animal', referencedColumnNames: 'id',
                            deferrable: true,
  ...
  changeSet(id: 'drop-foreign-key', author: 'stevesaliman') {
    dropForeignKeyConstraint(constraintName: 'monkey_emotion_fk', baseTableName: 'monkey_table', baseTableSchemaName: 'animal')
  }


  changeSet(id: 'add-primary-key', author: 'stevesaliman') {
    addPrimaryKey(schemaName: 'animal', tablespace: 'zoo',
		    tableName: 'monkey_table', columnNames: 'id', constraintName: 'monkey_pk')
  }
